...
public class BlankFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        txt_user=(EditText) view.findViewById(R.id.editText);
        txt_pass=(EditText) view.findViewById(R.id.editText2);
        btn_inicio =(Button) view.findViewById(R.id.button2);
        btn_inicio.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((MainActivity)getActivity()).HacerLogIn(txt_user.getText().toString(),txt_pass.getText().toString());
        ...
        btn_Mostrar_Registro.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ((MainActivity)getActivity()).MostrarCrearUsuario();
